...
export const RunStats = z.object({
  ...
  // Run spend in USD. Nullish = unknown (no usage reported, or the model has no
  // price) — and traces written before cost was tracked simply omit the key.
  // Unknown renders as "—", never "$0.00".
...
export const RunSummary = z.object({
  ...
  /** Run spend in USD; null = unknown, not free. Renders as "—". */
